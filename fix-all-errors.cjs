...
replaceRegex('src/engine/testing/__tests__/recovery.test.ts', /wrists: null,\s*wrists: null,/g, 'wrists: null,');

// 2. dropUnits -> pendantDropUnits
replaceAll('src/engine/anchors/necklaceAnchor.ts', 'meta.pendant.dropUnits', 'meta.pendant.pendantDropUnits');
...
// 6. calibration.test.ts reflectionSpec blur (which might not be in reflectionSpec type or something)
// "Object literal may only specify known properties, and 'blur' does not exist in type 'ReflectionSpec'"
