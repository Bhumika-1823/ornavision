...
export class GoldenImageTester {
   ...
   */
  static async compare(metadata: JewelryMetadata, goldenImageUrl: string): Promise<number> {
    const currentPreviewUrl = await PreviewGenerator.generateMannequinPreview(metadata, 300, 400);
