    ...
    return (
      <div className="min-h-screen bg-background pt-32 pb-20 flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-muted-foreground mb-8 max-w-md">
          Your shopping bag awaits our exquisite creations. Discover pieces that
          speak to you.
        </p>
        <Link
          href="/shop"
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20">
      <div className="container mx-auto px-4">
        <h1 className="brand-font text-4xl md:text-5xl text-foreground mb-12 text-center">
          Shopping Bag
        </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="col-span-1 md:col-span-6 flex items-center gap-4">
                      <Link
                        href={`/shop/${p.slug}`}
                        className="w-24 h-24 bg-black rounded border border-border/50 shrink-0 overflow-hidden mix-blend-screen p-2"
                      >
                        <img
                          src={p.images[0]}
                          alt={p.name}
                      ...
                      <div>
                        <Link href={`/shop/${p.slug}`}>
                          <h3 className="brand-font text-lg text-foreground hover:text-primary transition-colors leading-tight mb-1 pr-6 md:pr-0">
                            {p.name}
                          </h3>
                        </Link>
                    ...
                    <div className="col-span-1 md:col-span-2 flex justify-between md:justify-center items-center mt-2 md:mt-0">
                      <span className="md:hidden text-xs text-muted-foreground uppercase">
                        Price:
                      </span>
                    ...
                    <div className="col-span-1 md:col-span-2 flex justify-between md:justify-center items-center mt-2 md:mt-0">
                      ...
                      <div className="flex items-center border border-border rounded-sm h-8 w-24">
                        ...
                        <span className="text-center font-mono text-sm w-6">
                          {item.quantity}
                        </span>
                        <button
                          onClick={() =>
                            updateQty(
                              p.id,
                              Math.min(p.stock, item.quantity + 1),
                            )
                          }
                          className="flex-1 flex items-center justify-center text-muted-foreground hover:text-primary transition-colors"
                        >
          ...
          <div className="w-full lg:w-1/3">
            <div className="glass-card p-8 rounded-xl border border-primary/20 sticky top-28">
              <h2 className="brand-font text-2xl text-foreground mb-6 border-b border-border/50 pb-4">
                Order Summary
              </h2>
              ...
              <div className="space-y-4 mb-6 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-green-500 uppercase tracking-widest text-xs font-bold">
                    Complimentary
                  </span>
                </div>
              ...
              <div className="mb-6 pb-6 border-b border-border/50">
                ...
                {couponApplied && (
                  <p className="text-primary text-xs mt-2 flex justify-between">
                    Coupon applied!{" "}
                    <button
              ...
              <div className="flex justify-between items-end mb-8">
                <span className="text-foreground uppercase tracking-widest font-semibold">
                  Total
                </span>
