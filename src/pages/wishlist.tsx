...
export default function WishlistPage() {
  ...
  const wishlistedProducts = wishlist.map(id => PRODUCTS.find(p => p.id === id)).filter(p => p !== undefined);
  ...
  if (wishlist.length === 0) {
    return (
      <div className="min-h-screen bg-background pt-32 pb-20 flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 className="brand-font text-4xl text-foreground mb-4">Your Wishlist is Empty</h1>
        <p className="text-muted-foreground mb-8 max-w-md">Save your favorite pieces here while you decide. Discover masterpieces that resonate with you.</p>
    ...
    <div className="min-h-screen bg-background pt-24 pb-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center mb-16">
          <h1 className="brand-font text-4xl md:text-5xl text-foreground mb-4">Your Saved Curations</h1>
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="mt-auto">
                      <p className="text-primary font-medium tracking-wide text-lg mb-4">₹{product.price.toLocaleString()}</p>
                      ...
                      >
                        <ShoppingBag size={14} /> {product.stock > 0 ? 'Move to Cart' : 'Out of Stock'}
                      </button>
                    </div>
                  </div>
                </motion.div>
